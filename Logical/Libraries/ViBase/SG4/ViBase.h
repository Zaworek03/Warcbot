...
/* Constants */
 ...
 #define viBASE_ERR_ACQ_NOT_ACCEPTED (-1045167926)
 #define viBASE_ERR_FRCD_NOT_ACCEPTED (-1045167925)
 ...
 _GLOBAL_CONST signed long viBASE_ERR_ACQ_NOT_ACCEPTED;
 _GLOBAL_CONST signed long viBASE_ERR_FRCD_NOT_ACCEPTED;
